...
# Hardcoded scaler values from training data
PM25_MEAN = 7.460804
PM25_STD = 4.811239
POP_MEAN = 676599.7413793104
POP_STD = 1443820.844255374
...
if st.button("🔍 Predict Air Quality"):
    ...
    # Apply hardcoded StandardScaler values from training
    pm25_scaled = (pm25 - PM25_MEAN) / PM25_STD
    pop_scaled = (population - POP_MEAN) / POP_STD
